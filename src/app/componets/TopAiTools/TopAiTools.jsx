                    ...
                    {cards.map((card, index) => (
                            <div key={index} className='rounded-md px-4 py-3 overflow-hidden hover:dark:bg-dark-grey dark:bg-dark-black dark:text-white w-full bg-white hover:bg-light-gray border-1 dark:border-card-border'>
                                ...
                                <div className='flex justify-between my-4'>
                                    ...
                                    <div className='flex items-center rounded-md text-dark-black dark:bg-dark-bg-btn dark:hover:bg-transparent dark:border-card-color border-1 border-gray-300 hover:bg-gray-500'>
                                        <button className=' flex items-center px-1 rounded cursor-pointer dark:text-black dark:font-semibold border-1 dark:hover:text-white' >
                                            <Link href='/Ai-ToolsDetail' onClick={() => getAiData(card.title)} className='flex items-center'><p className='text-sm me-1'>Visit</p>
                                            <HiExternalLink />
                                            </Link>
                                        </button>
                                    </div>
